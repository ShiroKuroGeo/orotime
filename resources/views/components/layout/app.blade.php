            ...
            <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
                ...
                <div class="offcanvas-body pt-3 pb-4 py-lg-0 mx-lg-auto">
                    <ul class="navbar-nav position-relative">
                        ...
                        <li class="nav-item py-lg-2 me-lg-n2 me-xl-0">
                            <a class="nav-link text-primary"
                                href="{{ route('CategoryProduct', ['cat' => 'new arrival']) }}">New Arrival</a>
                        </li>
                        <li class="nav-item py-lg-2 me-lg-n2 me-xl-0">
                            <a class="nav-link text-primary"
                                href="{{ route('CategoryProduct', ['cat' => 'best seller']) }}">Best Seller</a>
                        </li>
                        <li class="nav-item py-lg-2 me-lg-n2 me-xl-0">
                            <a class="nav-link text-primary"
                                href="{{ route('CategoryProduct', ['cat' => 'necklace']) }}">Necklace</a>
                        </li>
                        <li class="nav-item py-lg-2 me-lg-n2 me-xl-0">
                            <a class="nav-link text-primary"
                                href="{{ route('CategoryProduct', ['cat' => 'earring']) }}">Earrings</a>
                        </li>
                        <li class="nav-item py-lg-2 me-lg-n2 me-xl-0">
                            <a class="nav-link text-primary"
                        ...
                        <li class="nav-item py-lg-2 me-lg-n2 me-xl-0">
                            <a class="nav-link text-primary"
                                href="{{ route('CategoryProduct', ['cat' => 'all golds']) }}">All Golds</a>
                        </li>
                        <li class="nav-item py-lg-2 me-lg-n2 me-xl-0">
                            <a class="nav-link text-primary"
                                href="{{ route('CategoryProduct', ['cat' => 'all silver']) }}">All Silvers</a>
                        </li>
                    </ul>
                </div>
            </div>
