            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                <li class="nav-item my-2">
                    <div class="nav-item-wrapper">
                        <a class="nav-link {{ Request::routeIs('csr-dashboard') ? 'active' : '' }} "
                            href="{{ route('csr-dashboard') }}">
                ...
                <li class="nav-item my-2">
                    ...
                    <div class="nav-item-wrapper">
                        <a class="nav-link dropdown-indicator label-1 {{ Request::routeIs('csr-category') || Request::routeIs('product-csr-add') || Request::routeIs('product-list') ? 'active' : '' }}"
                                    ...
                                    <div class="parent-wrapper">
                                        <ul class="nav collapse parent show" data-bs-parent="#e-commerce"id="nv-admin">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                    href="{{ route('product-csr-add') }}">
                                                    <div class="d-flex align-items-center"><span
                                                            class="nav-link-text">Add product</span></div>
                                                </a>
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="{{ route('csr-category') }}">
                                                    <div class="d-flex align-items-center">
                ...
                <li class="nav-item my-2">
                    <div class="nav-item-wrapper">
                        <a class="nav-link dropdown-indicator label-1 {{ Request::routeIs('csr-order') ? 'active' : '' }}"
                            href="{{ route('csr-order', 0) }}">
                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle" src="#" alt="" /></div>
...
<nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop">
    ...
    <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center"
        ...
        <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle lh-1" href="{{ route('csr-dashboard') }}" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                    <span class="uil fs-8 me-2 uil-chart-pie"></span>
                    Home
                </a>
            </li>
                            ...
                            <div class="row gx-4 gy-5">
                                <div class="col-12 col-sm-6 col-md-4">
                                    <div class="dropdown-item-group"><span class="me-2" data-feather="file-text"
                                        ...
                                        href="../modules/forms/basic/select.html">Select</a><a class="dropdown-link"
                ...
                <div class="card position-relative border-0">
                    <div class="card-body p-0">
                        <div class="text-center pt-4 pb-3">
                            ...
                            <h6 class="mt-2 text-body-emphasis">Shiro George Alfeser</h6><br><span
                                class="text-muted fw-lighter">Customer</span>
                        </div>
                    ...
                    <div class="overflow-auto scrollbar" style="height: 10rem;">
                        <ul class="nav d-flex flex-column mb-2 pb-1">
                            <li class="nav-item"><a class="nav-link px-3 d-block" href="#!"> <span
                                        class="me-2 text-body align-bottom p-1" data-feather="user"></span>
                                    <span>Profile</span></a></li>
                            <li class="nav-item"><a class="nav-link px-3 d-block" href="#!"><span
                                        class="me-2 text-body align-bottom"
                                        data-feather="pie-chart"></span>Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link px-3 d-block" href="#!"> <span
                                        class="me-2 text-body align-bottom p-1"
                                        data-feather="log-out"></span></span>Logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
