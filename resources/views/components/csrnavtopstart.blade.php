...
<nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop">
    ...
    <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center"
        ...
        <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            <li class="dropdown mx-4">
                <a class="nav-link lh-1" href="{{ route('csr-dashboard') }}">
                    <i data-feather="pie-chart" class="me-2" style="width: 16px; height: 16px"></i>
                    Dashboard
                </a>
            </li>
            <li class="dropdown mx-4">
                <a class="nav-link lh-1" href="{{ route('product-list') }}">
                    <i data-feather="shopping-bag" class="me-2" style="width: 16px; height: 16px"></i>
                    Products
                </a>
            </li>
            <li class="dropdown mx-4">
                <a class="nav-link lh-1" href="{{ route('order-list') }}">
    ...
    <ul class="navbar-nav navbar-nav-icons flex-row">
        ...
        <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#navbarDropdownUser"
                ...
                <div class="card position-relative border-0">
                    <div class="card-body p-0">
                        <div class="text-center pt-4 pb-3">
                            ...
                            <p class="mt-2 pb-0 text-body-emphasis">Shiro George Alfeser</p>
                            <p class="text-muted mt-0 pt-0 fw-lighter">Customer</p>
                        </div>
                    </div>
                    <div class="overflow-auto scrollbar border-top shadow-top g-5" style="height: 6rem;">
                        <ul class="nav d-flex flex-column my-2 pb-1">
                            <li class="nav-item">
                                <a class="nav-link px-3 d-block d-flex align-items-center" href="#!">
                                    <span class="me-2 text-body align-bottom p-1" data-feather="user"></span>
