<x-layout.app>
    <main class="main py-5" id="top">
        <section class="container pb-5 mb-1 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5 my-5">
            <div class="row">

                <div class="col-md-6">
                    <img src="{{ asset('images/orotime-images/product-image.png') }}" alt=""
                ...
                <div class="col-md-6 col-xl-5 offset-xl-1 pt-4">
                    <div class="ps-md-4 ps-xl-0">
                        <div class="position-relative" id="zoomPane">
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-3">
                                <div class="mb-0 me-3 text-oro-color"><span class="link-primary">17</span> Available
                                    to
                                    order</div>
                            </div>
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-3">
                                <div class="mb-0 me-3 text-oro-color">
                                    <a href="https://www.facebook.com/messages/t/100042639916265" target="_blank"
                                ...
                                <div class="mb-0 me-3 text-oro-color d-flex align-items-center">
                                    <span class="link-primary pe-1 cursor-pointer" data-bs-toggle="modal"
                                        data-bs-target="#shareModal">
                                        <i data-feather="share-2" style="height: 20px; width: 20px"></i>
                                        Share
                                    </span>
                            ...
                            <div
                                ...
                                <a type="button"
                                    href="{{ route('guestPurchaser', ['pid' => Request::route('proId')]) }}"
        ...
        {{-- <div class="py-5">
            {{ Request::route('refId') }} <br>
            {{ Request::route('proId') }} <br>
        </div> --}}
