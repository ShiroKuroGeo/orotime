            ...
            <div class="row row-cols-2 row-cols-md-4 g-3">
                    ...
                    <div class="d-flex flex-column flex-xxl-row align-items-center">
                        <div class="rounded-circle p-4 mb-3 mb-xxl-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="bi bi-credit-card-2-back-fill icon-responsive" viewBox="0 0 16 16">
                                <path
                ...
                <div class="col">
                    <div class="d-flex flex-column flex-xxl-row align-items-center">
                        <div class="rounded-circle p-4 mb-3 mb-xxl-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="bi bi-headset icon-responsive" viewBox="0 0 16 16">
                                <path
                ...
                <div class="col">
                    <div class="d-flex flex-column flex-xxl-row align-items-center">
                        <div class="rounded-circle p-4 mb-3 mb-xxl-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="bi bi-shield-lock-fill icon-responsive" viewBox="0 0 16 16">
                ...
                <div class="col">
                    <div class="d-flex flex-column flex-xxl-row align-items-center">
                        <div class="rounded-circle p-4 mb-3 mb-xxl-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="bi bi-globe icon-responsive" viewBox="0 0 16 16">
                                <path
