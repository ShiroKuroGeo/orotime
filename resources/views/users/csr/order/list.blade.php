        ...
        <div class="mb-9">
            ...
            <div id="orderTable">
                        ...
                        <div class="col-auto">
                            <div class="search-box">
                                <form class="position-relative">
                                    <input class="form-control search-input search" id="search-order-csr" type="search"
                ...
                <div class="px-4 px-lg-6 position-relative bg-body-emphasis rounded" id="orderTableInCSR"
                    data-list='{"valueNames":["order","product","customer","payment_status","fulfillment_status","date"],"page":10,"pagination":true}'>
                        ...
                        <table class="table table-responsive table-hover table-stripe fs-9 mb-0 display">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort align-middle text-start pe-3" scope="col"
                                        data-sort="fulfillment_status" style="width: 15%;"> FULFILLMENT STATUS </th>
                            ...
                            <tbody class="list" id="products-table-body">
                                @for ($i = 1; $i <= 15; $i++)
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="align-middle white-space-nowrap text-start fw-bold text-body-tertiary fulfillment_status">
                                            <span class="badge badge-oro fs-10 badge-oro-primary"><span
                                                    class="badge-label">Completed </span> <span class="ms-1"
                                                    data-feather="x"
                                                    style="height:12.8px;width:12.8px;"></span></span>
                                        </td>
