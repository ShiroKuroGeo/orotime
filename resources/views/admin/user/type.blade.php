                                ...
                                @for ($i = 1; $i <= 15; $i++)
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            ...
                                            <a href="#!" class="badge bg-light">
                                                <i data-feather="edit" class="fs-base text-primary" style="width: 16px; height: 16px"></i>
                                            </a>
                                            <a href="{{ route('user-details', ['type' => encryptData(Request::route('type')), 'uid' => encryptData($i) ]) }}" class="badge bg-light">
                                                <i data-feather="eye" class="fs-base text-primary-dark" style="width: 16px; height: 16px"></i>
                                            </a>
                                        </td>
                                    </tr>
                                @endfor
