                    ...
                    <div class="card border border-translucent auth-card">
                        <div class="card-body pe-md-0">
                            <div class="row align-items-center gx-0 gy-7">
                                <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box me-3 order-md-2">
                                    <div class="bg-holder" style="background-image:url({{ asset('images/orotime-images/flyer1.jpg') }});">
                                    </div>
                                    <div class="position-relative z-n1 mb-6 d-none d-md-block text-center mt-md-5">
                                        <img class="auth-title-box-img d-dark-none rounded mb-1" src="{{ asset('images/orotime-images/flyer1.jpg') }}" alt="" />
                                        <img class="auth-title-box-img d-light-none rounded" src="{{ asset('images/orotime-images/flyer1.jpg') }}" alt="" />
                                    </div>
                                </div>
                                ...
                                <div class="col mx-auto order-md-1">
                                    <div class="auth-form-box">
                                        <div class="text-center">
                                            ...
                                            <form class="d-flex align-items-center mb-5" method="post" action="{{ route('passwordEmail') }}">
                                                @csrf
...
@if (session('success'))
    <script>
        toastr.info('Request Forgot Password!');
    </script>
@endif