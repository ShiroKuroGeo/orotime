                ...
                <div class="row position-relative align-items-center justify-content-center z-2 py-xl-4">
                    ...
                    <div class="col-10 col-sm-7 col-md-6 col-lg-5 col-xxl-4 offset-lg-1 offset-xxl-2 order-md-2">
                        <svg width="447" viewBox="0 0 447 420" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path class="d-none-dark" d="M44 374V97H403V374H44Z" fill="url(#paint0_linear_2921_40054)">
                            </path>
                            ...
                            <path class="text-body-emphasis" style="animation-duration: 1.75s"
                            ...
                            <g clip-path="url(#clip0_2921_40054)">
                                <path class="animate-down-up text-body-emphasis" fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="currentColor"></path>
                                <path class="animate-down-up text-body-emphasis"
                                    style="animation-duration: 3s; animation-delay: .35s" fill-rule="evenodd"
                                    clip-rule="evenodd"
                                    ...
                                    fill="currentColor"></path>
                                <path class="animate-down-up text-body-emphasis"
                                    style="animation-duration: 3s; animation-delay: .75s" fill-rule="evenodd"
                                    clip-rule="evenodd"
                            ...
                            <defs>
                                <filter id="filter0_f_2921_40054" x="0" y="322" width="447" height="98"
                                    filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                    <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                                    <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape">
                                    </feBlend>
                                    <feGaussianBlur stdDeviation="15" result="effect1_foregroundBlur_2921_40054">
                                    </feGaussianBlur>
                                </filter>
                                <linearGradient id="paint0_linear_2921_40054" x1="195" y1="125"
                                    x2="275" y2="338" gradientUnits="userSpaceOnUse">
                                    <stop offset="0" stop-color="#ffffff"></stop>
                                    <stop offset="1" stop-color="#eff5fd"></stop>
                                </linearGradient>
                                <linearGradient id="paint1_linear_2921_40054" x1="229.5" y1="101.5"
                                    x2="229.5" y2="74" gradientUnits="userSpaceOnUse">
                                    <stop offset="0" stop-color="#9ca3af"></stop>
                                    <stop offset="1" stop-color="#d2d4d9"></stop>
                                </linearGradient>
                                <linearGradient id="paint0_linear_6256_34079" x1="229.5" y1="101.5"
                                    x2="229.5" y2="74" gradientUnits="userSpaceOnUse">
                    ...
                    <div class="col-md-5 col-xxl-4 offset-md-1 order-md-1">
                        <div class="text-center text-md-start px-4 px-sm-5 px-md-0">
                            ...
                            <p class="pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-5">The page you are looking for was moved,
                                removed or might never existed. Here some helpful links:</p>
                            <div class="position-relative">
                                <i
                                    class="ci-search position-absolute top-50 start-0 translate-middle-y fs-lg ms-3"></i>
